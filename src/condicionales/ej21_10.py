...
def menu(tipo):
    ...
    if tipo == "Vegetariana":
        ...
        if ingrediente == "pimiento":
            ingredientes_basicos.append(ingredientes_vegetarianos[0])
        elif ingrediente == "tofu":
            ingredientes_basicos.append(ingredientes_vegetarianos[1])
        else:
        ...
        if ingrediente == "peperoni":
            ingredientes_basicos.append(ingredientes_no_vegetarianos[0])
        elif ingrediente == "jamon":
            ingredientes_basicos.append(ingredientes_no_vegetarianos[1])
        elif ingrediente == "salmon":
            ingredientes_basicos.append(ingredientes_no_vegetarianos[2])
        else:
...
def mostrar_info(tipo, ingredientes):
    ingredientes_f = ", ".join(ingredientes)
    print(f"Tu pizza es {tipo} y contiene {ingredientes_f}")
